...
### Changed
- Updated `@anthropic-ai/claude-agent-sdk` to 0.3.158 in all packages (`cyrus-core`, `cyrus-edge-worker`, `cyrus-simple-agent-runner`). Tool list is unchanged (33 tools). See the [SDK changelog](https://github.com/anthropics/claude-agent-sdk-typescript/blob/main/CHANGELOG.md) for details. ([CYPACK-1270](https://linear.app/ceedar/issue/CYPACK-1270))
